...
<body>
                ...
                <section class="container flex justify-between">
                    <article class="container flex justify-between">
                        ...
                        <section class=" flex justify-between border border-dark ">
                            <br><br>
                            <form id="registroForm" method="POST" action="registroUser.php"
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $id_departamento = $_POST['departamento']; // ID del departamento seleccionado
        $id_ciudad = $_POST['Ciudad']; // ID de la ciudad seleccionada
        $contrasena = $_POST['contrasena'];
        $contrasena2 = $_POST['contrasena2'];
        $id_perfil = $_POST['tipo_perfil']; // ID del perfil seleccionado
          ...
          //  echo '<script language="javascript">alert("El Documento ya está registrado, validar " );</script>';
            ...
            if ($result->num_rows > 0) {
               // echo '<script language="javascript">alert("El correo electrónico ya está registrado, volver a validar");</script>';
                ...
                $sql = "INSERT INTO usuarios (usuario, nombre, apellidos, correo, contrasena, contrasena2, fecha_nacimiento, id_ciudad, id_departamento, id_perfil, tipo_documento, numero_identidad, telefono) 
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                $stmt = $conn->prepare(query: $sql);
                $stmt->bind_param("sssssssssssss", $usuario, $nombre, $apellidos, $correo, $contrasena_hash, $contrasena2, $fecha_nacimiento, $id_ciudad, $id_departamento, $id_perfil, $tipo_documento, $numero_identidad, $numero_telefono);
