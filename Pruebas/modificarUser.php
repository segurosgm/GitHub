                    ...
                    <article class="container flex justify-between">
                        ...
                        <section class=" flex justify-between border border-dark ">
                            ...
                            <?php if ($usuario): ?>
                                ...
                                <form method="POST" action="/GM/Pruebas/actualizar_usuario.php">
                                    <br><br>
                                    <div>
                                    ...
                                    <br><br>
                                    <div>
                                        <?php echo "<p><strong>Numero Id: </strong>" . $usuario['Id'] . "</p>"; ?>
                                    </div>
                                    <br><br>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="Nombre" name="Nombre"
                                            value="<?php echo $usuario['Nombre']; ?>" required><br><br>
                                        <label for="apellidos">Apellidos:</label>
                                        <input type="text" id="apellidos" name="apellidos"
                                            value="<?php echo $usuario['Apellidos'] ?? ''; ?>" required><br><br>

                                        <!-- Campo de Fecha de Nacimiento -->
                                        <label for="fecha_nacimiento">Fecha de Nacimiento:</label>
                                        <input type="date" id="fecha_nacimiento" name="fecha_nacimiento"
                                            value="<?php echo $usuario['Fecha_Nacimiento'] ?? ''; ?>" required><br><br>
                                        <label for="correo">Correo electrónico:</label>
                                        <input type="email" id="correo" name="correo"
                                            value="<?php echo $usuario['Correo'] ?? ''; ?>" required><br><br>
                                        <!-- Campo de Número de Teléfono -->
                                        <label for="telefono">Número de Teléfono:</label>
                                        <input type="text" id="telefono" name="telefono"
                                            value="<?php echo $usuario['Telefono'] ?? ''; ?>" required><br><br>
                                             <label for="contrasena">Contraseña:</label>
                                        <input type="password" id="contrasena" name="contrasena"
                                            value="<?php echo $usuario['Contrasena'] ?? ''; ?>" required><br><br>
                                        <label for="confirmar_contrasena">Confirmar contraseña:</label>
                                        <input type="password" id="Contrasena2" name="Contrasena2"
                                            value="<?php echo $usuario['Contrasena2'] ?? ''; ?>" required><br><br>
